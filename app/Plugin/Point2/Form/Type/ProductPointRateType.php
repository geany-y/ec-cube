...
*/
namespace Plugin\Point2\Form\Type;
use Eccube\Form\Type\ProductClass;
use Symfony\Component\Form\AbstractType;
use Symfony\Component\Form\FormBuilderInterface;
use Symfony\Component\OptionsResolver\OptionsResolver;
use Symfony\Component\Validator\Constraints as Assert;
use Plugin\Point2\Doctrine\EventSubscriber\SaveEventSubscriberExtends;
...
class ProductPointRateType extends AbstractType
{
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Plugin\Point2\Entity\ProductPointRate',
        ));
    }
    ...
    {
        return 'admin_product_point_rate2';
    }
}
