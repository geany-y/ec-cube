...
/**
 * PaginatorTest test cases.
 *
 * @author Yasumasa Yoshinaa
 */
class PaginatorTest extends EccubeTestCase
{
    protected $Customer;
    protected $Order;
    ...
    private function _createPriceCreateSearchData(){
    ...
    //期待通りのオブジェクトがかえってくること
    public function scenario()
    {
        $this->searchData = $this->_createPriceCreateSearchData();
        $this->queryBuilder = $this->app['eccube.repository.order']->getQueryBuilderBySearchData($this->searchData)
        $this->Paginator = new \Eccube\Paginator\Paginator();
    }
