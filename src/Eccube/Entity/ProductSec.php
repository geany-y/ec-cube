 ...
 * Product
 */
class ProductSec extends \Eccube\Entity\AbstractEntity
{
    private $_calc = false;
     ...
     * Set Status
     *
     * @param  \Eccube\Entity\Master\DispSec $status
     * @return Product
     */
    public function setStatus(\Eccube\Entity\Master\DispSec $status = null)
    {
        $this->Status = $status;
